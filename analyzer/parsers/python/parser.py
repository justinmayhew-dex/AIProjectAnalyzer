...
def parse_python(file_name, file_contents):
    tree = ast.parse(file_contents, filename=str(file_name))
    
    ir = {
        "path": str(file_name),
        "name": os.path.splitext(os.path.basename(str(file_name)))[0],
        "module_name": os.path.splitext(os.path.basename(str(file_name)))[0],
        "imports": [],
        "exports": [],
        "functions": [],
        "classes": [],
